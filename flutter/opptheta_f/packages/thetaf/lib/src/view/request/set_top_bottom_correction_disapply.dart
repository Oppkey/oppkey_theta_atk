...
class SetTopBottomCorrectionDisApplyButton extends StatelessWidget {
  ...
  const SetTopBottomCorrectionDisApplyButton({
    Key? key,
    this.style,
    this.focusNode,
  ...
  Widget build(BuildContext context) {
    return OutlinedButton(
        ...
        onPressed: () async {
          var response =
              await setOption(name: '_topBottomCorrection', value: 'Disapply');
          // set title for response. Edit the line below
          // for each option
          response = 'attempting to disapply  topBottomCorrection\n'
                  '-------------------\n' +
              response;
