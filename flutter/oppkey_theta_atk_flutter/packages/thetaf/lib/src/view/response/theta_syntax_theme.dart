...
class ThetaSyntaxTheme {
  ...
  static ThetaSyntaxTheme standard() {
    return ThetaSyntaxTheme(
  ...
  static ThetaSyntaxTheme dracula() {
    return ThetaSyntaxTheme(
  ...
  static ThetaSyntaxTheme ayuLight() {
    return ThetaSyntaxTheme(
        linesCountColor: const Color(0xFF37474F).withOpacity(.7),
  ...
  static ThetaSyntaxTheme ayuDark() {
    return ThetaSyntaxTheme(
  ...
  static ThetaSyntaxTheme gravityLight() {
    return ThetaSyntaxTheme(
        linesCountColor: const Color(0xFF37474F).withOpacity(.7),
        backgroundColor: const Color(0xFFFAFAFA),
        baseStyle: const TextStyle(color: const Color(0xFF202734)),
  ...
  static ThetaSyntaxTheme gravityDark() {
    return ThetaSyntaxTheme(
        linesCountColor: const Color(0xFFFFFFFF).withOpacity(.8),
        backgroundColor: const Color(0xFF202734),
        baseStyle: const TextStyle(color: const Color(0xFFFFFFFF)),
  ...
  static ThetaSyntaxTheme monokaiSublime() {
    return ThetaSyntaxTheme(
        linesCountColor: const Color(0xFFFFFFFF).withOpacity(.7),
  ...
  static ThetaSyntaxTheme obsidian() {
    return ThetaSyntaxTheme(
        linesCountColor: const Color(0xFFFFFFFF).withOpacity(.7),
  ...
  static ThetaSyntaxTheme oceanSunset() {
    return ThetaSyntaxTheme(
        linesCountColor: const Color(0xFFFFFFFF).withOpacity(.7),
  ...
  static ThetaSyntaxTheme vscodeDark() {
    return ThetaSyntaxTheme(
        linesCountColor: const Color(0xFFFFFFFF).withOpacity(.7),
  ...
  static ThetaSyntaxTheme vscodeLight() {
    return ThetaSyntaxTheme(
