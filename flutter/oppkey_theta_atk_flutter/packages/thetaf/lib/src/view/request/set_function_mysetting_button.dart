...
/// Set shooting setting to My Setting. Setting at the same time as
/// exposureDelay will result in an error.
class SetFunctionMySettingButton extends StatelessWidget {
  ...
  const SetFunctionMySettingButton({
    Key? key,
    this.style,
    this.focusNode,
    this.autofocus = false,
    this.clipBehavior = Clip.none,
    this.label = 'DO_NOT_USE_mySetting',
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return OutlinedButton(
        ...
        onPressed: () async {
          var response = await setOption(name: '_function', value: 'mySetting');
