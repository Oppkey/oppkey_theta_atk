...
class SetBitrateVideoNormalButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OutlinedButton(
        ...
        onPressed: () async {
          var response = await setOption(name: '_bitrate', value: 'Normal');
          // set title for response. Edit the line below
          // for each option
          response = 'attempting to set option for _bitrate\n'
                  '-------------------\n' +
              response;
