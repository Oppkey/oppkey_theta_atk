...
class SetWhiteBalanceIncandescent1Button extends StatelessWidget {
  ...
  const SetWhiteBalanceIncandescent1Button({
    Key? key,
    this.style,
    this.focusNode,
    this.autofocus = false,
    this.clipBehavior = Clip.none,
    this.label = 'Incandescent Light 1',
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return OutlinedButton(
        ...
        onPressed: () async {
          var response =
              await setOption(name: 'whiteBalance', value: 'incandescent');
